...
Matrix Camera::LookAt(const Vector3f& eyePos, const Vector3f& lookat, const Vector3f& upAxis)
{
	...
	Matrix m;
	m.value[0][0] = rightDir.x;	 m.value[0][1] = rightDir.y;  m.value[0][2] = rightDir.z;  m.value[0][3] = -eyePos.x;
	m.value[1][0] = upDir.x;     m.value[1][1] = upDir.y;	  m.value[1][2] = upDir.z;	   m.value[1][3] = -eyePos.y;
	m.value[2][0] = lookDir.x;	 m.value[2][1] = lookDir.y;	  m.value[2][2] = lookDir.z;   m.value[2][3] = -eyePos.z;
